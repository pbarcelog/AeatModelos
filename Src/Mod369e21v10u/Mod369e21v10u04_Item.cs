...
namespace AeatModelos.Mod369e21v10u
{
    ...
    /// <summary>
    /// Página T36907 Un modelo 369. Diseño de registro: DR369e21.xlsx.
    /// Entregas de bienes expedidos o transportados desde otros EM distintos de España. 
    /// Régimen de la Unión.
    /// </summary>
    public class Mod369e21v10u04_Item : RegistroModPagina
    {
        ...
        public Mod369e21v10u04_Item(string ejercicio, string periodo) : base(ejercicio, periodo)
        {

            Modelo = "369";

            string p = "V04";   // clave página (Prefijo 'V': Item de Régimen de la Unión)
            int c = 0;          // contador
