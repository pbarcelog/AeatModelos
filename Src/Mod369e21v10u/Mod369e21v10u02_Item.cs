...
namespace AeatModelos.Mod369e21v10u
{
    ...
    /// <summary>
    /// Página T36905 Un modelo 369 T36905 Un.  Diseño de registro: DR369e21.xlsx.
    /// Entregas de bienes expedidos o transportados desde EMID España.
    /// Régimen de la Unión
    /// </summary>
    public class Mod369e21v10u02_Item : RegistroModPagina
    {
        ...
        public Mod369e21v10u02_Item(string ejercicio, string periodo) : base(ejercicio, periodo)
        {

            Modelo = "369";

            string p = "V02";   // clave página (Prefijo 'V': Item de Régimen de la Unión)
            int c = 0;          // contador
