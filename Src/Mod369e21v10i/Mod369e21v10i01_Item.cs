...
namespace AeatModelos.Mod369e21v10i
{
    ...
    /// <summary>
    /// Página T36911 Imp modelo 369 T36904 Un.  Diseño de registro: DR369e21.xlsx.
    /// Prestaciones de servicios.
    /// Régimen de importación
    /// </summary>
    public class Mod369e21v10i01_Item : RegistroModPagina
    {
        ...
        public Mod369e21v10i01_Item(string ejercicio, string periodo) : base(ejercicio, periodo)
        {

            Modelo = "369";

            string p = "J01";   // clave página (Prefijo 'J': Item de Régimen de importación)
            int c = 0;          // contador
