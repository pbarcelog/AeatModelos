...
namespace AeatModelos.Mod111e16v18
{
    ...
    /// </summary>
    public class Mod111e16v18 : RegistroModPagina
    { 
        ...
        public Mod111e16v18(string ejercicio, string periodo) : base(ejercicio, periodo)
        {

            PaginasMapa = new Dictionary<int, string>()
            {
                {1, "AeatModelos.Mod111e16v18.Mod111e16v18p01"}
            };
            ...
            RegistroCampos = new Dictionary<decimal, IEmpaquetable>()
            {
                ...
                {++c,    new RegistroCampo(0,   3,   3,  "An",   Txt.Den[$"{p}.{("" + c).PadLeft(3,'0')}"],    null,  "111"                   )},
                ...
                {++c,    new ConjuntoDeEmpaquetables(){ Empaquetables = new List<IEmpaquetable>(){
                            new Mod111e16v18p01(Ejercicio, Periodo)
                } } },
        ...
        {
            Mod111e16v18p01 modPagina1 = Paginas.Empaquetables[0] as Mod111e16v18p01;

            string[] clavesRetenciones = {"03", "06", "09", "12", "15", "18", "21", "24", "27" };

            decimal totalRetenciones = 0;

            foreach (var claveRetencion in clavesRetenciones)
