...
namespace AeatModelos.Mod349e20v00
{
    ...
    /// </summary>
    public class Mod349e20v00 : RegistroModPagina
    {
        ...
        public Mod349e20v00(string ejercicio, string periodo) : base(ejercicio, periodo)
        {
            ...
            RegistroCampos = new Dictionary<decimal, IEmpaquetable>()
            {
                ...
                {++c,    new RegistroCampo(0,   2,   3,  "Num",  Txt.Den[$"{p}.{("" + c).PadLeft(3,'0')}"],    null,  349,         0          )}, // 02
        ...
        public override Respuesta Presentar(bool test = false, string certRef = null, string certClave = null)
        {
            ...
            peticionInicializarEnvio.PeticionHttp.Headers.Add("MODELO", "349");
