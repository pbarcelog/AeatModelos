...
namespace AeatModelos.Mod190e2017v00
{
    ...
    public class Txt
    {
        ...
        public static Dictionary<string, string> Den = new Dictionary<string, string>() {
            ...
            {"000.013", "NÚMERO TOTAL DE PERCEPCIONES."},
            {"000.014", "IMPORTE TOTAL DE LAS PERCEPCIONES. SIGNO NEGATIVO."},
            {"000.015", "IMPORTE TOTAL DE LAS PERCEPCIONES."},
            {"000.016", "IMPORTE TOTAL DE LAS RETENCIONES E INGRESOS A CUENTA."},
            {"000.017", "CORREO ELECTRÓNICO DE LA PERSONA CON QUIEN RELACIONARSE."},
            {"000.018", "BLANCOS."},
            {"000.019", "SELLO ELECTRÓNICO."},
            {"000.020", "Contenido del fichero.  Aquí se debe incluir el contenido de las páginas correspondientes a la declaración según el formato descrito para cada página en este mismo documento."},
