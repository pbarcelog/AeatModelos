    ...
    public class Mod130e15v11p01 : RegistroMod
    {
        ...
        public Mod130e15v11p01(string ejercicio, string periodo) : base(ejercicio, periodo)
        {
            ...
            RegistroCampos = new Dictionary<decimal, IEmpaquetable>()
            {
                ...
                {++c,    new RegistroCampo(1,   143,   17,  "N",        Txt.Den[$"{p}.{("" + c).PadLeft(3,'0')}"],      "03",                  0, 2             )},
                ...
                {++c,    new RegistroCampo(1,   330,   17,  "N",        Txt.Den[$"{p}.{("" + c).PadLeft(3,'0')}"],      "14",                  0, 2             )},
                ...
                {++c,    new RegistroCampo(1,   381,   17,  "N",        Txt.Den[$"{p}.{("" + c).PadLeft(3,'0')}"],      "17",                  0, 2             )},
